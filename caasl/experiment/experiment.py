...
from ..dowel import CsvOutput, StdOutput, TensorBoardOutput, TextOutput
...
class ExperimentTemplate:
    ...
    def _make_context(cls, options, **kwargs):
        ...
        if options["use_existing_dir"]:
            print("Using existing log directory", log_dir)
        ...
        # Git archiving disabled - skip archive creation
        ...
        logger.add_output(TensorBoardOutput(log_dir, x_axis=options["x_axis"]))
...
def get_metadata():
    ...
    Returns:
        tuple[str, dict[str, str]]:
          * None (no git repo)
          * Dictionary containing basic launcher info
    ...
    # Return basic info without git operations
    return None, {
...
def make_launcher_archive(*, git_root_path, log_dir):
    """Placeholder function - git archiving disabled.

    Args:
        git_root_path (str): Ignored
        log_dir (str): Ignored
    """
    # Git archiving disabled - do nothing
